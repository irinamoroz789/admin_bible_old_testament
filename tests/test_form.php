        ...
        <div class="form-inner">
            <div class="form">
                ...
                <div id="inputFormQuestion_0" class="inputFormQuestion" data-answer_count="1">
                    ...
                    <div id="addQuestion" onclick="addQuestion(this)"><span class="noselect" onchange="addAnswer()">Добавить вопрос</span>
                        <div id="circle"></div>
                    </div>
                    <br>
                    ...
                    <div id="inputFormAnswer_0_1" class="inputFormAnswer">
                        <div class="input-group">
                            <input type="text" name="answer_0_1" class="form-control m-input"
                                   placeholder="Введите ответ" autocomplete="off">
                            <div class="input-group-append">
                                <button id="removeAnswer" type="button" class="btn-danger" onclick="deleteAnswer(this)">
                                    Удалить
                                </button>
                            </div>
                        </div>
                    ...
                    <br>
                    <input type="number" name="response_answer_0" class="response_answer" min="1" step="1"
                           placeholder="Номер ответа" onchange="this.value = parseInt(this.value);"><br>
                    <div class="input-file-row">
                        <label class="input-file">
                            <input type="file" name="image_0" class="image" multiple accept="image/*"
                    ...
                    <textarea placeholder="Комментарий к ответу..." name="comment_0" class="comment"
                              rows="3"></textarea><br>
                </div>
            </div>
