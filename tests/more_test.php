                            ...
                            <div class="accordion" id="comment_<?=$i?>">
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="heading_<?=$i?>">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_<?=$i?>" aria-expanded="false" aria-controls="collapse_<?=$i?>">

                                            <span>Комментарий</span> </button>
                                    </h2>
                                    <div id="collapse_<?=$i?>" class="accordion-collapse collapse show"  data-bs-parent="#comment_<?=$i?>">
